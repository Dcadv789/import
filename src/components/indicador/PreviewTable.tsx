        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tipo Estrutura</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tipo Dado</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.slice(0, 5).map((row, index) => (
              <tr key={index}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{row.tipo_estrutura}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{row.tipo_dado}</td>
